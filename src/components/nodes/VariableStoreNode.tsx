...
export function VariableStoreNode({ id, data }: NodeProps) {
  ...
  return (
    <div className="node-shell w-52">
      ...
      <div className="node-header bg-amber-600 flex justify-between items-center">
        <span>{d.mode === 'get' ? '📖 Get Var' : '📝 Set Var'}</span>
